...
object Unit01 {
  ...
  @main def exercise11(): Unit =
    println(incr(1))
    println(incr(1))
    println(decr(2))
    println(decr(decr(90)))
    println(incr(incr(1)))
    println(incr(decr(incr(10))))
    println(dbl(8))
    println(sqr(4))
    println(halve(50))
    println(cube(3))
  ...
  @main def exercise12b(): Unit =
    ...
    println(nums.map(add(1))) //partial application very useful
  ...
  @main def exercise13(): Unit =
    ...
    println(s"Using mul(2): ${nums.map(mul(2))}")
    println(s"Using mul(10): ${nums.map(mul(10))}")
    println(s"negate: ${nums.map(negate)}")
    println(s"Using div(36): ${nums.map(div(36))}")
    println(s"Using divBy(2): ${nums.map(divBy(2))}")
  ...
  @main def exercise15(): Unit =
    ...
    println(nums.map(divBy(2)(_)))
    println(nums.map(divBy(_)(2)))
  ...
  @main def exercise16(): Unit =
    ...
    println(nums.map(mul(10).compose(add(10))))
  ...
  @main def exercise19(): Unit =
    println((flip compose flip)(sub)(21)(14))
    println((flip compose flip)(sub)(21)(14) == (flip compose flip)(sub)(21)(14))
